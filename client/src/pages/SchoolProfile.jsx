...
function SchoolProfile() {
  ...
  const handleCardClick = (school) => {
    setSelected(selected?._id === school._id ? null : school)
  }
    ...
    <div className="school-page">
      ...
      <div className="school-hero">
        <div className="school-hero-content">
          ...
          <p>EduBridge partners with government schools to provide volunteers, books, and learning resources to students who need them most.</p>
        </div>
      </div>
      ...
      <div className="school-body">
        ...
        {!loading && schools.length === 0 && (
          <div className="no-schools">
            ...
            <p>Be the first to register your school with EduBridge!</p>
          </div>
        )}
        ...
        {!loading && schools.length > 0 && (
          <div className="schools-grid">
            {schools.map(school => (
              <div key={school._id}>
                <div
                  className={`school-card ${selected?._id === school._id ? 'active' : ''}`}
                ...
                >
                  ...
                  <div className="school-card-footer">
                    ...
                    <span className="view-btn">{selected?._id === school._id ? 'Hide Details ↑' : 'View Details ↓'}</span>
                  </div>
                </div>
        ...
        <div className="register-school-section">
          <div className="register-school-banner">
            <div>
              ...
              <p>Register your school with EduBridge and get access to volunteers, book donations, and learning resources.</p>
            </div>
